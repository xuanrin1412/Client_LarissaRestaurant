...
function Footer() {
    ...
    //     };
    // }, [showCategoryBar]);
    return <div className="p-20  bg-black flex items-center  flex-col w-full ">
        <div className="w-4/5 mx-auto ">
            {/* LOGO */}
            <div className="font-bold   text-white flex text-4xl  items-center w-fit  text-center">
            ...
            <div className="flex justify-between">
                <div className="text-white w-1/4  flex flex-col items-center mt-14 text-xl">
                    <div className="text-3xl bg-gradient-to-r from-[#FF006B] to-[#749BF7] bg-clip-text text-transparent font-bold">Open hours </div>
                    <div className="mt-4">Monday {"-->"} Friday</div>
                    <div className="mb-6">09:00 - 22:00</div>
                    <div className="text-3xl bg-gradient-to-r from-[#d63030] to-[#749BF7] bg-clip-text text-transparent font-bold">Close</div>
                    <div className="mt-4">Sartuday & Sunday </div>
                </div>
                <div className="text-white w-8/12   mt-14 text-xl">
                    <div>
